  ...
  return (
    <div>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        <SubHeading title="Reject Ticket?" className="mt-0 mb-4" />
        <Paragraph
          title={
            "Are you sure you want to reject this ticket? The user will be prompted that you rejected the request"
          }
          className="mb-8"
        />
        <Textarea content="There is a fire on the mountain" />
        
        <Button
          className="mb-6"
          onClick={rejectTicketHandler}
          title={isLoading ? "Hang on dude..." : "Reject ticket"}
          type="submit"
        />
      </Modal>
    </div>
